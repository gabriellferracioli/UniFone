              ...
              <div class="tab-pane active" id="settings">
                <form class="form-horizontal" action="">
                  <div class="form-group">
                    ...
                    <div class='row'>
                        <div class="col-sm-2">
                        <input name="ADM" type="nome" class="form-control" id="inputADM" placeholder="ADM" value="" >        
                        </div>
                        <div>
                        <a href="{{route('cadligacao')}}"  class="btn btn-success" >Buscar</a>
                        </div>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input name="razaosocial" type="name" class="form-control" id="inputrazao" placeholder="">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputAssunto" class="col-sm-2 control-label">Assunto</label>
                        <div class="col-sm-6">
                            <input name="assunto" type="name" class="form-control" id="inputassunto" placeholder="">
                        </div> 
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea name='observacoes' class="form-control" rows="5" id="inputObservacoes"></textarea>
                    </div>
                  </div>           
                  <div class="form-group">
