                ...
                <form class="form-horizontal" action="{{route('inserirlig')}}">
                  ...
                  <div class="form-group">
                    <label for="inputAssunto" class="col-sm-2 control-label">Assunto</label>
                        <div class="col-sm-6">
                            <input name="assunto" type="name" class="form-control" id="inputassunto" placeholder="" maxlength='255' required>
                        </div> 
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea name='observacoes' class="form-control" rows="5" id="inputObservacoes" maxlength='255' required></textarea>
                    </div>
                  </div>           
                  <div class="form-group">
