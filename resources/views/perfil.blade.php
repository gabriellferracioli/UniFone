              ...
              <div class="tab-pane active" id="settings">
                <form class="form-horizontal" action="{{route('alterarper')}}">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <input name="idmovidesk" type="name" class="form-control" id="inputidmovidesk" placeholder="" value="{{$usuario->idmovidesk}}" maxlength=10 required>
                    </div>
                    <label for="inputtime" class="col-sm-1 control-label">Grupo</label>
                    <div class="col-sm-4">
                      <input name="time" type="name" class="form-control" id="inputtime" placeholder="" value="{{$usuario->time}}" required>
                    </div>
                  </div>
                  <div class="form-group">
