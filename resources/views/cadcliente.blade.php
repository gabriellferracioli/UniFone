...
<div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#settings" data-toggle="tab" aria-expanded="true">Cadastrar Cliente</a></li>
            </ul>
            <div class="tab-content">
              <div class="tab-pane active" id="settings">
                <form class="form-horizontal" action="{{route('inserircli')}}">
                  <div class="form-group">
                        <label for="inputcnpj" class="col-sm-2 control-label">CNPJ</label>
                        <div class="col-sm-4">
                            <input name="cnpj" type="number" class="form-control" id="inputcnpj" min="0" max="999999999999999999" required>
                        </div>
                     </div>
                  <div class="form-group">
